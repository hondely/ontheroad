...
<div class="container wp-margin-bottom-50px">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <div class="thumbnail">
                    <img alt="缩略图" id="thumbnailImg"  onclick="showWpUploader()" src="/ontheroad/Public/WeChat/images/order/homeHeader.png" style="height: 240px; width: 540px; display: block;cursor: pointer;">
                </div>
            </div>
            <input type="text" style="display: none" name="thumbnail" id="thumbnail" value="/ontheroad/Public/WeChat/images/order/homeHeader.png">
        </div>
        ...
        <div class="form-group" style="text-align: center">
            ...
            <div class="col-sm-2">
                <input type="number" min="0.01" step="0.01" class="form-control" id="price" placeholder="">
            </div>
        </div>
