...
<div class="container wp-margin-bottom-50px">
    ...
    <div class="form-horizontal">
        <input type="text" style="display: none" name="id" id="id" value="<?php echo ($info["id"]); ?>">

        <div class="form-group">
            <label class="col-sm-2 control-label">房型缩略图</label>
            <div class="col-sm-6">
                <div class="thumbnail">
                    <img alt="缩略图" id="thumbnailImg"  onclick="showWpUploader()" src="<?php echo ($info["thumbnail"]); ?>" style="height: 240px; width: 540px; display: block;cursor: pointer;">
                </div>
            </div>
        ...
        <div class="form-group" >
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control" name="name" id="name" placeholder="" value="<?php echo ($info["name"]); ?>">
            </div>
        </div>
        ...
        <div class="form-group" style="text-align: center">
            ...
            <div class="col-sm-2">
                <input type="number" min="1" class="form-control" id="price" name="price" value="<?php echo ($info["price"]); ?>" placeholder="">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="brief" name="brief" value="<?php echo ($info["brief"]); ?>" placeholder="">
            </div>
        </div>
...
<script>
    ...
    function saveInfo(){
        ...
        var url="<?php echo U('RoomManage/detail');?>";
        $.ajax({
            data: data,
            type: "POST",
            url: url,
